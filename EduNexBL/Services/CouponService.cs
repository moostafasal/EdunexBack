...
namespace EduNexBL.Services
{
    public class CouponService
    {
        ...
        public Coupon GenerateCoupon(decimal value, int numberOfUses, int daysValid)
        {
        ...
        {
            var coupon = _context.Coupon.FirstOrDefault(c => c.CouponCode == couponCode && c.NumberOfUses > 0 && c.ExpirationDate > DateTime.Now);
            if (coupon == null)
            {
